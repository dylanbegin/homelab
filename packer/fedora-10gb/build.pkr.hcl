...
source "proxmox-iso" "fedora-10gb" {
  ...
  vm_id                = "1011"
  vm_name              = "fedora-10gb"
  template_description = "Fedora 38 Template"

  # VM OS Settings
  iso_storage_pool = "nomad"
  iso_file         = "nomad:iso/fedora-38.iso"
  unmount_iso      = true
  os               = "l26"
...
build {
  ...
  name    = "fedora-10gb"
  sources = ["source.proxmox-iso.fedora-10gb"]
  ...
  provisioner "shell" {
    ...
    inline = [
      ...
      "sudo dnf remove firewalld linux-firmware man-db nano shared-mime-info sssd-client -y",
      "sudo dnf install https://mirrors.rpmfusion.org/free/fedora/rpmfusion-free-release-$(rpm -E %fedora).noarch.rpm -y",
      "sudo dnf install https://mirrors.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm -y",
      "sudo dnf distro-sync -y",
      "sudo dnf update -y",
      "sudo dnf install bind-utils cloud-init foot-terminfo tar -y",
